 ...
 */
package com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids;  
...
public class legacyIdFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"legacyIdFields\",\"namespace\":\"com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids\",\"fields\":[{\"name\":\"LEGACY_ID_COMPANY_REGISTERED_NUMBER\",\"type\":[\"null\",\"string\"],\"doc\":\"Supplied Company Number\",\"default\":null,\"dataClassification\":\"3\"}]}");
  ...
  public static com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder();
  }
  
  /** Creates a new legacyIdFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder newBuilder(com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder other) {
    return new com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<legacyIdFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields other) {
            super(com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.SCHEMA$);
      if (isValidValue(fields()[0], other.LEGACY_ID_COMPANY_REGISTERED_NUMBER)) {
        this.LEGACY_ID_COMPANY_REGISTERED_NUMBER = data().deepCopy(fields()[0].schema(), other.LEGACY_ID_COMPANY_REGISTERED_NUMBER);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'LEGACY_ID_COMPANY_REGISTERED_NUMBER' field */
    public com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder setLEGACYIDCOMPANYREGISTEREDNUMBER(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.purposing.companies.companyregisterlegacy.latest.standardisedfields.entity.commercial.legacyids.legacyIdFields.Builder clearLEGACYIDCOMPANYREGISTEREDNUMBER() {
